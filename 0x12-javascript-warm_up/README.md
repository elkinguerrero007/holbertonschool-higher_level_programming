...
#### **_Documentation._**   (https://github.com/standard/semistandard) 👈  [![built in](https://travis-ci.org/joemccann/dillinger.svg?branch=master)](https://github.com/standard/semistandard)
